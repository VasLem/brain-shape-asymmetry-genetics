function peer = plotHierarchicalLabelsDGorsAsText(peer,rend,SegmentVal, caxis_min_max, clmap, crit)
...
%                 end
                text(double(nodes_levels{level}(cl,1)),double(nodes_levels{level}(cl,2)),num2str(labels{level}(cl)),'HorizontalAlignment','Center','FontWeight','Normal','FontSize',8);
%                 if level<8
%                     text(double(nodes_levels{level}(cl,1)),double(nodes_levels{level}(cl,2)),num2str(labels{level}(cl)),'HorizontalAlignment','Center');
%                 else
%                     text(double(nodes_levels{level}(cl,1)),double(nodes_levels{level}(cl,2)),num2str(labels{level}(cl)),'HorizontalAlignment','Center');
%                 end
            end
