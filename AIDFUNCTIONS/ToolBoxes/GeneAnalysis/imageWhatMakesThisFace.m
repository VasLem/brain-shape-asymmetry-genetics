function imageWhatMakesThisFace(BaseFace,AmplFace,comparison,RefScanV,vref,name,saveresults)
...
%% imaging the norm
        [v,RefScan] = cloneAndDisplay(vref,RefScanV,'Vertices',AmplFace.Vertices,'Single',[name '_Pred'],[]);
        if saveresults,savingResults(v,RefScan);end
