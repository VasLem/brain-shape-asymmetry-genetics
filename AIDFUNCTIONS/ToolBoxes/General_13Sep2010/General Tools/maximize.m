...
% MAXIMIZE resize a figure to fill the screen (© Yuval Cohen)
% -----------
% maximize(h)
% -----------
% Description: resize figure {h} to fill the screen.
...
%               OS:	WinXP
%               maximize('calibrate')
%                   The function was calibrated to handle WinXP standard
%                   toolbar (at the bottom of the screen, one icon row) and
%                   standard screen (4x3 ratio - not wide). If you are
%                   using different settings, the maximized figure size
%                   could be wrong. If you find yourself in such a
%                   position, fear not. Run the function in 'calibrate'
%                   mode to calibrate the settings. The application will
%                   ask you to maximize a figure window manually and use
%                   these settings as a reference from now on.
%               maximize('forget')
%                   forget the calibration settings (delete the file) and
%                   use default settings from now on.
