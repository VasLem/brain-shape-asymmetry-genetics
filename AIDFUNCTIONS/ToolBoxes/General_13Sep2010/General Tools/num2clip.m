...
% NUM2CLIP copies a numerical-array to the clipboard (© Grigor Browning)
% -----------------------------
% ARRAYSTRING = NUM2CLIP(ARRAY)
% -----------------------------
% Description: Copies the numerical array ARRAY to the clipboard as a
%              tab-separated string.  This format is suitable for direct
%              pasting to Excel and other programs.
%   
