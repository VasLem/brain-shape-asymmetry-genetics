function constructDisplayLite(obj)
...
%                hold off;
               ...
               obj.PopLM = LMObj('Vertices',obj.Pop(:,obj.vAxes)','Value',ones(size(obj.Scores)));
               obj.PopLM.SingleColor = [0 0 0];
               obj.PopLM.ColorMode = 'Single';
               obj.vPop = viewerLite;
               set(obj.vPop.Figure,'Position',[140.0000   64.9231   80.2000   22.8462]);
               obj.vPop.AxesVisible = false;
               obj.vPop.AxesGrid = false;
               obj.vPop.AxesBox = false;
               ...
               colormap(obj.vPop.RenderAxes,'gray');
