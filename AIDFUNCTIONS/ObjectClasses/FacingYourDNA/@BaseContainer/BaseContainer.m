classdef BaseContainer < superClass
   ...
   methods % STAGE 4 GETTING/SETTING
       function out = get.ST4Fold(obj)
                if isempty(obj.ST4MOD), out = []; return; end
                out = obj.ST4MOD.StatFold;
       end
       function out = get.ST4PFold(obj)
                if isempty(obj.ST4MOD), out = []; return; end
                out = obj.ST4MOD.PFold;
       end
