classdef JanusEvoMorphEDA < superClass
    ...
    methods % Constructor
        function obj = JanusEvoMorphEDA(varargin)
    ...
    methods % General Interface Functions for the evolution proccess
        ...
        function nextGeneration(obj)
            obj.mu = mean(obj.Population(obj.sortIndex(1:obj.Reduction),:));
            obj.Sigma = cov(obj.Population(obj.sortIndex(1:obj.Reduction),:));
            obj.Population = mvnrnd(obj.mu,obj.Sigma,obj.PopulationSize);
        end
