function expectations = fitscalingshiftlinear(obj)
%FITSCALINGSHIFTLINEAR Offset and scale fitness to desired range (single objective only).
...
%   $Revision: 1.1.6.4 $  $Date: 2011/05/09 00:50:30 $
scores = obj.Scores;
nParents = obj.nrParents;
MaximumSurvivalRate = obj.MaximumSurvivalRate;
