classdef SNPMV < CATMV
   ...
   methods % GETTING/SETTING
       ...
       function out = get.GGGTBal(obj)
          if isempty(obj.GT), out = []; return; end
          out = SNPMV.getGGGTBalance(obj.GG,obj.GT);
       end
       ...
       function out = get.Balances(obj)
           ...
           out(1) = SNPMV.getBalance(obj.nAA+obj.nAB,obj.nBB);% Recessive
           out(2) = SNPMV.getBalance(obj.nBB+obj.nAB,obj.nAA);% Dominant
           out(3) = SNPMV.getBalance(obj.nAA+obj.nBB,obj.nAB);% Over Dominant
           out(4) = SNPMV.getBalance(obj.nAA,obj.nBB);% AA versus BB
           out(5) = SNPMV.getBalance(obj.nAA,obj.nAB);% AA versus AB
           out(6) = SNPMV.getBalance(obj.nAB,obj.nBB);% AB versus BB
       end
   ...
   methods % INTERFACING
       ...
       function postFeatureLearning(obj)
           [obj.MODBal,obj.MODMinBal] = SNPMV.getGGBalance(obj.XMOD); % GG without nan is coded in XMOD
       end
