classdef superClassSNP < hgsetget & dynamicprops
...
%     (addprop)
    ...
    methods %Constructor
        function obj = superClassSNP(varargin)
    ...
    methods% Special Setting & Getting
        ...
        function obj = set.Type(obj,in) %#ok<INUSD>
            return;%dummy
        end
    end
...
%             end
        ...
        function out = validH(obj,handle)
            ...
            out = mysuperClassSNP.isH(H);% isH is a function defined in objectclass Utilities            
        end
    end
    methods (Static = true)
