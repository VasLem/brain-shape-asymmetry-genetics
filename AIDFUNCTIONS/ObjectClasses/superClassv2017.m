classdef superClassv2017 < matlab.mixin.SetGet
...
%     (addprop)
    ...
    methods %Constructor
        function obj = superClassv2017(varargin)
    ...
    methods% Interface Functions
        ...
        function out = validH(obj,handle)
            ...
            out = superClassv2017.isH(H);% isH is a function defined in objectclass Utilities            
        end
    end
    methods (Static = true)
