function [f] = SYNMiamiplotUnion(BPOS,BCHR,BP,FPOS,FCHR,FP,pGW,pSWB,pSWF,mode,cmap,peaks)
...
%     POS = un(:,1);
    ...
    f.CurrentAxes.YTick = [-50 -40 -30 -20 -10 -4 4 10 20 30 40 50];
