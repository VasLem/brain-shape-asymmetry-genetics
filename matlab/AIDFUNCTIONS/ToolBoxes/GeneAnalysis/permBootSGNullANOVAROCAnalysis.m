function [out,figures] = permBootSGNullANOVAROCAnalysis(A,B,Model,t,string,type,G)
...
%          type = 'Mahalanobis';
         ...
         %Est = myregressSingleGeneLOO(A,B,Model,type);
         Est = myBootstrapRegressSingleGeneLOO(A,B,Model,type);
         X = G;Y = Est;
         out.GeneDP = Est;
         % perform ANOVA
         [FA,pFA] = myAnova(X,Y);
