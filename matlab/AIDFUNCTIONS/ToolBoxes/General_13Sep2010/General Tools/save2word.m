...
% SAVE2WORD saves plots to Microsoft Word (© Suresh E. Joel).
% --------------------------
% save2word(filespec,prnopt)
% --------------------------
% Description: saves the current Matlab figure window or Simulink model
%              window to a Word file designated by filespec.  If filespec
%              is omitted, the user is prompted to enter one via UIPUTFILE.
%              If the path is omitted from filespec, the Word file is
