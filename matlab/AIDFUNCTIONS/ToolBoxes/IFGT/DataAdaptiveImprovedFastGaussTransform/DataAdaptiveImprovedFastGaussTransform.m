function [G,T]=DataAdaptiveImprovedFastGaussTransform(d,N,M,X,h,q,Y,p_max,K,ClusterIndex,ClusterCenter,ClusterRadii,r,epsilon)
...
%
%     A new version of the IFGT where the parameters are chosen  based on the acutal distribution of the source points.
%     The truncation number for each source point is different and is chosen based on its distance to the cluster center.
%
...
%% See also
%
%  ImprovedFastGaussTransform, ImprovedFastGaussTransformChooseParameters,  ImprovedFastGaussTransformChooseTruncationNumber,  KCenterClustering,  example
