classdef superClassLight < hgsetget & dynamicprops
...
%     (addprop)
    ...
    methods %Constructor
        function obj = superClassLight(varargin)
    ...
    methods% Special Setting & Getting
        ...
        function obj = set.Type(obj,in) %#ok<*MCHV2,INUSD>
            return;%dummy
        end
    end
...
%             end
        ...
        function out = validH(obj,handle)
            ...
            out = mysuperClassLight.isH(H);% isH is a function defined in objectclass Utilities            
        end
    end
    methods (Static = true)
