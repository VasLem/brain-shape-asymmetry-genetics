function out = mySNPLDEM(geno1,geno2,model)
...
% populations
         ...
         switch lower(model)
             case 'codominant-codominant'
                 ...
                 values = [2 1 0];
                 for i=1:1:3
                    index1 = geno1==values(i);
                    for j=1:1:3
                        index2 = geno2==values(j);
                        index = index1+index2;
                        Table(i,j) = sum(index==2);
                    end   
                 end
                 %Table
                 ...
                 switch sign(D)
                     ...
                     case 0 % exceptional case D == 0
                         Dmax = 1;
                     otherwise
                         % input is not valid, return nan values!!
                         out.D = nan;
                         out.Dmax = nan;
                         out.Dprime = nan;
                         out.k = nan;
