function GWAS = SH_LoadBRAINGWASScriptCHIv2
    %% LOADING BRAIN GWAS
...
%     cd(GENOPATH);
    ...
    in = load('/IMAGEN/BRAIN/UKBIOBANK/PHENOTYPES/SH/AUX_SH_PA80_20200513.mat');
    HS{1}.IID = in.DB.IID;
    ...
    GWAS.SIGNSH = SIGNLH;
    GWAS.SIGNSWH = SIGNRH;
    clear CHR POS RS PLH PRH A1 A2 MAF N CHILH CHIRH SIGNLH SIGNRH;
%% THE END
end
