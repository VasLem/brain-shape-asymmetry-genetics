function GWAS = LoadBrainThicknessGWAS(INPUTPATH, OUTPUTPATH, AUXFILE)
% INPUTPATH = '/IMAGEN/BRAIN/UKBIOBANK/GENOTYPES/SNPJOBSv500/';
% OUTPUTPATH = '/usr/local/micapollo01/IMAGEN_DATA/UKbiobank/GWAS/OUTPUT/SM100_PV60/';
% in = load('/usr/local/micapollo01/MIC/DATA/STAFF/myuan0/tmp/BrainThickness/CODE/Peaks/AUX_ShapeMask100_PercVar60.mat');
in = load(AUXFILE);
IID = in.DB.IID;
