...
%close all;clear all;
function GWAS = LoadFACIALGWASScriptv2
...
%     PHENOPATH = [studypath 'PHENOTYPES/'];
    INPUTPATH = '/IMAGEN/FACE/EUROGWAS/GENOTYPES/SNPJOBSINTERSECTpoint8/';
    OUTPUTPATH = '/IMAGEN/FACE/EUROGWAS/GENOTYPES/OUTPUTINTERSECT_FULLSTATS/';
    PHENOPATH = '/IMAGEN/FACE/EUROGWAS/PHENOTYPES/';
