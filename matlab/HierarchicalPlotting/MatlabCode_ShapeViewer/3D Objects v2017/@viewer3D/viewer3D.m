classdef viewer3D < superHandleClass
    ...
    methods %Constructor
        function obj = viewer3D(varargin)
          ...
          obj.MouseRobot = Robot;
          obj.MouseExtent = InputEvent.BUTTON2_MASK;
          obj.MouseNormal = InputEvent.BUTTON1_MASK;
          obj.MouseAlt = InputEvent.BUTTON3_MASK;
    ...
    methods % INTERFACING
        ...
        function updateArea(obj,area,Vindex)
            ...
            area.PatchHandle.PickableParts = 'none';
            area.PatchHandle.HitTest = 'off';
        end
        function emulateExtentClick(obj)
            obj.MouseRobot.mousePress(obj.MouseExtent);
            pause(0.05);
            obj.MouseRobot.mouseRelease(obj.MouseExtent);
        end
        function emulateNormalClick(obj)
            obj.MouseRobot.mousePress(obj.MouseNormal);
            pause(0.05);
            obj.MouseRobot.mouseRelease(obj.MouseNormal);
        end
        function emulateAltClick(obj)
            obj.MouseRobot.mousePress(obj.MouseAlt);
            pause(0.05);
            obj.MouseRobot.mouseRelease(obj.MouseAlt);
        end
    end
