classdef viewer3DObj < matlab.mixin.SetGet
    ...
    properties
        ...
        SelectionMode = 'none'% the selection mode (none, landmarks, area)
        LandmarkSelection = [];
        AreaSelection = [];
        AreaSelectionRadius = [];
        SelectionSphere = [];
    ...
    methods %Constructor
        function obj = viewer3DObj(varargin)
          if nargin>0
        ...
        function obj = set.CalledProcess(obj,process)
                 ...
                 switch process
                     case 'indicatePoseLM'
                         ...
                         obj.SelectionActive = true;
                         %obj.CurrentMesh.Selected = true;
