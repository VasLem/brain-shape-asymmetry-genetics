...
[m,n]=size(X);
    if verLessThan('matlab','8.4.0')
        ...
        ax = obj.RenderAxes;
        axchild = obj.CurrentMesh.ph;
        
        XYZ = convertDataSpaceCoordsToViewerCoords(axchild, get(axchild,'vertices')');
        
        P1 = point1(1,:);
        P2 = point2(1,:);
         
        P1 = convertDataSpaceCoordsToViewerCoords(ax, P1);
        P2 = convertDataSpaceCoordsToViewerCoords(ax, P2);
