...
\begin{figure}[H]
	...
	\caption[Effect of 1000G phase3 \acs{snp} set filtering on entire hemisphere \acs{gwas}]{Entire hemisphere \ac{gwas}, with grayed out the \acp{snp} removed when filtering with 1000G phase3 \ac{snp} set data.}
